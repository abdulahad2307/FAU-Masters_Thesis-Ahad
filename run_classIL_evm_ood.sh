...
#SBATCH --job-name=eaml_cil_evm_ood_SILS          # Job name
...
#2
#BASE_MODEL="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_evm_ood_SILS_Final/best_model_scientific_publication.pth"
...
#3
#BASE_MODEL="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_evm_ood_SILS_Final/best_model_specification.pth"
...
#4
BASE_MODEL="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_evm_ood_SILS_Final/best_model_file_folder.pth"
...
CKPT_DIR="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_evm_ood_SILS_Final" #eaml_cil_evm_ood_with_bsamp_with_bcor_$(date +%Y%m%d_%H%M%S)"
...
python src/class_incremental_evm_ood.py \
  ...
  --lambda_ood 0.1 \
  #--resume \
  #--resume_checkpoint "/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_evm_ood_SILS_Final/epoch5_specification.pth" \
  #--global_best_acc 0.953.  # 0.9321, 0.8849  , 0.8443

echo "Class Incremental Learning WITH EVM+OOD Completed."


# To run:
# sbatch run_classIL_evm_ood.sh
