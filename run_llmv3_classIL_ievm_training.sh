...
#SBATCH --job-name=llmv3_CIL_ievm_training       # Job name
...
CKPT_DIR="/home/woody/iwi5/iwi5280h/llmv3_cil/llmv3_cil_models_ievm_final" #eaml_cil_with_bsamp_with_bcor_20250903_072048/"
...
#2
#BASE_MODEL="/home/woody/iwi5/iwi5280h/llmv3_cil/llmv3_cil_models_ievm_final/layoutlmv3_cil_incremental_ievm_scientific_publication_best.pt"
...
#3
BASE_MODEL="/home/woody/iwi5/iwi5280h/llmv3_cil/llmv3_cil_models_ievm_final/layoutlmv3_cil_incremental_ievm_specification_best.pt"
...
echo "Starting LayoutLMv3 Class Incremental Learning iEVM..."

python src/llmv3_class_incremental_ievm_training.py \
...
echo "LayoutLMv3 Class Incremental Learning iEVM Completed."


# To run:
# sbatch run_llmv3_classIL_ievm_training.sh
