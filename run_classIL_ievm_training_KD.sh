...
#SBATCH --job-name=eaml_cil_ievm_training_KDILS          # Job name
...
#2
#BASE_MODEL="home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_ievm_training_KDILS_Final/best_model_scientific_publication.pth"
...
#RESUME_CKPT="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_ievm_training_KDILS_Final/epoch5_specification.pth"

#3
#BASE_MODEL="home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_ievm_training_KDILS_Final/best_model_specification.pth"
...
#4
BASE_MODEL="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_ievm_training_KDILS_Final/best_model_file_folder.pth"
...
CKPT_DIR="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_ievm_training_KDILS_Final" #eaml_cil_evm_training_with_bsamp_with_bcor_$(date +%Y%m%d_%H%M%S)"
...
python src/class_incremental_ievm_training.py \
  ...
  --evm_tailsize 0.3 \
  --evm_threshold 0.7 \
  --full_model_acc 0.9067 \
  --patience 5 \
  #--resume \
  #--resume_checkpoint "$RESUME_CKPT" \
  #--global_best_acc <previous_global_best_acc> #0.9321 ,0.8495, 0.9067

echo "Class Incremental Learning WITH iEVM Completed."


# To run:
# sbatch run_classIL_ievm_training_KD.sh
