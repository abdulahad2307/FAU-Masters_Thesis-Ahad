...
#SBATCH --job-name=dil_evm_ood_KDILS          # Job name
...
CHECKPOINT_DIR="/home/woody/iwi5/iwi5280h/dil_models/eaml_dil_evm_ood_KDILS2"
...
echo "========================================="
echo "Starting Domain Incremental Learning with EVM + OOD"
echo "Data Directory: ${DATA_DIR}"
echo "Device: $(nvidia-smi -L)"
echo "========================================="

python src/domain_incremental_evm_ood.py \
  --data_dir "${DATA_DIR}" \
  --ocr_tensor_dirs "None" "/home/woody/iwi5/iwi5280h/dataset/Tobacco3482_ocr_texts_tesseract.pt" \
  --domains "all_prepdataset,Tobacco3482-jpg" \
...
echo "========================================="
echo "Domain Incremental Learning WITH EVM + OOD Completed"
...
# To run:
# sbatch run_domainIL_evm_ood_KD.sh
