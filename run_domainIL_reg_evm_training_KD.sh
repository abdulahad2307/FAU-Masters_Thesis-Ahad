...
#SBATCH --job-name=dil_reg_evm_training_KDILS         # Job name
...
CHECKPOINT_DIR="/home/woody/iwi5/iwi5280h/dil_models/eaml_dil_reg_evm_training_KDILS2"
...
echo "========================================="
echo "Starting Domain Incremental Learning with RegEVM (train+eval)"
echo "Data Directory: ${DATA_DIR}"
echo "Device: $(nvidia-smi -L)"
echo "========================================="

python src/domain_incremental_reg_evm_training.py \
  --data_dir "${DATA_DIR}" \
  --ocr_tensor_dirs "None" "/home/woody/iwi5/iwi5280h/dataset/Tobacco3482_ocr_texts_tesseract.pt" \
  --domains "all_prepdataset,Tobacco3482-jpg" \
...
echo "========================================="
echo "Domain Incremental Learning (RegEVM Training + Evaluation) Completed"
echo "Checkpoints saved in: ${CHECKPOINT_DIR}"


# To run:
# sbatch run_domainIL_reg_evm_training_KD.sh
