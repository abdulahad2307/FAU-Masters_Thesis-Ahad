...
#SBATCH --job-name=dil_ievm_training_SILS         # Job name
...
CHECKPOINT_DIR="/home/woody/iwi5/iwi5280h/dil_models/eaml_dil_ievm_training_SILS2"
...
# To run:
# sbatch run_domainIL_ievm_training.sh
