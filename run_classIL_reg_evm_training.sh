...
#SBATCH --job-name=eaml_cil_reg_evm_training_SILS          # Job name
...
#2
#BASE_MODEL="home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_Regevm_training_SILS_Final/best_model_scientific_publication.pth"
...
#RESUME_CKPT="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_Regevm_training_SILS_Final/epoch6_specification.pth"

#3
#BASE_MODEL="home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_Regevm_training_SILS_Final/best_model_specification.pth"
...
#4
BASE_MODEL="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_Regevm_training_SILS_Final/best_model_file_folder.pth"
...
CKPT_DIR="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_Regevm_training_SILS_Final" #eaml_cil_evm_training_with_bsamp_with_bcor_$(date +%Y%m%d_%H%M%S)"

#RESUME_CKPT="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_Regevm_training_SILS_Final/epoch16_file_folder.pth"
...
python src/class_incremental_reg_evm_training.py \
  ...
  --evm_tailsize 0.3 \
  --evm_threshold 0.7 \
  --full_model_acc 0.6904 \
  --patience 5 \
  #--resume \
  #--resume_checkpoint "$RESUME_CKPT" \
  #--global_best_acc <previous_global_best_acc> # 0.9321 , 0.8521

echo "Class Incremental Learning WITH RegEVM Completed."


# To run:
# sbatch run_classIL_reg_evm_training.sh
