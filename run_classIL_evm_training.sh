...
#SBATCH --job-name=eaml_cil_evm_training_SILS         # Job name
...
#2
#BASE_MODEL="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_evm_training_SILS_Final/best_model_scientific_publication.pth"
...
#3
#BASE_MODEL="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_evm_training_SILS_Final/best_model_specification.pth"
...
#4
BASE_MODEL="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_evm_training_SILS_Final/best_model_file_folder.pth"
...
#5
#BASE_MODEL="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_evm_training_SILS_Final/best_model_news_article.pth"
...
#UNSEEN_CLASSES="budget"


# Incremental Training on
#UNSEEN_CLASSES="budget" #"scientific_publication,specification,file_folder,news_article,budget"

CKPT_DIR="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_evm_training_SILS_Final" #eaml_cil_evm_training_with_bsamp_with_bcor_$(date +%Y%m%d_%H%M%S)"


#RESUME_CKPT="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_evm_training_SILS_Final/epoch7_scientific_publication.pth"

mkdir -p $CKPT_DIR

echo "Starting Class Incremental Learning WITH EVM..."

python src/class_incremental_evm_training.py \
  --data_dir "$DATA_DIR"  \
  ...
  --evm_tailsize 0.3 \
  --evm_threshold 0.7 \
  --full_model_acc 0.7906 \
  --patience 5 \
  #--resume \
  #--resume_checkpoint "$RESUME_CKPT" \
  #--global_best_acc <previous_global_best_acc> # 0.9321, 0.8585, 0.8073, 0.7906

echo "Class Incremental Learning WITH EVM Completed."


# To run:
# sbatch run_classIL_evm_training.sh
