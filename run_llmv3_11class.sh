...
#SBATCH --job-name=FixedImage_10k_llmv3_11_class_training_tesseract_adamW          # Job name
#SBATCH --output=Fixed_llmv3_logs/%x-2_%j.out           # Standard output log
#SBATCH --error=Fixed_llmv3_logs/%x-2_%j.err            # Error log
...
OUTPUT_DIR="/home/woody/iwi5/iwi5280h/FixedImage_llmv3/11_class_125k_LLMV3_AdamW_tesseract_$(date +%Y%m%d_%H%M%S)"  
...
DATASET=${1:-"rvl_cdip"}
CLASSES=${2:-"letter,form,email,handwritten,advertisement,scientific_report,invoice,presentation,questionnaire,resume,memo"}
OCR_TENSOR_DIR=${3:-"/home/woody/iwi5/iwi5280h/dataset/all_predataset_combined_ocr_texts_rectbbox_tesseract.pt"}
IMAGE_DIR=${4:-"/home/woody/iwi5/iwi5280h/dataset/all_prepdataset"}
BBOX_STYLE=${5:-"rect"}    # or "rect", "poly"; must match your OCR tensor style
...
python src/sota_llmv3_model.py \
    ...
    --seed 42 \
    --resume /home/woody/iwi5/iwi5280h/FixedImage_llmv3/11_class_125k_LLMV3_AdamW_tesseract_20251108_032206/layoutlmv3_rvl_cdip_best.pt \
    --resume_epoch 14

echo "Training Completed. Output: $OUTPUT_DIR"

#sbatch run_llmv3_11class.sh
