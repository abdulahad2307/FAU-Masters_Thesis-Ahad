...
#SBATCH --job-name=dil_llmv3_ievm_training          # Job name
...
CHECKPOINT_DIR="/home/woody/iwi5/iwi5280h/llmv3_dil_ievm_training_final"
...
python src/llmv3_domain_incremental_ievm_training.py \
  --data_dir /home/woody/iwi5/iwi5280h/dataset \
...
# To run:
# sbatch run_llmv3_domainIL_ievm.sh
