...
#SBATCH --job-name=eaml_cil_reg_evm_training_KDILS          # Job name
#SBATCH --output=CILlogs/%x_4_%j.out    # Standard output log
#SBATCH --error=CILlogs/%x_4_%j.err     # Error log
...
#2
#BASE_MODEL="home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_Regevm_training_KDILS_Final/best_model_scientific_publication.pth"
...
#RESUME_CKPT="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_Regevm_training_KDILS_Final/epoch8_specification.pth"

#3
#BASE_MODEL="home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_Regevm_training_KDILS_Final/best_model_specification.pth"
...
#4
BASE_MODEL="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_Regevm_training_KDILS_Final/best_model_file_folder.pth"
...
CKPT_DIR="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_Regevm_training_KDILS_Final" #eaml_cil_evm_training_with_bsamp_with_bcor_$(date +%Y%m%d_%H%M%S)"

#RESUME_CKPT="/home/woody/iwi5/iwi5280h/eaml_cil_Regevm_training_KDILS_Final/epoch10_file_folder.pth"

mkdir -p $CKPT_DIR

echo "Starting Class Incremental Learning WITH RegEVM..."

python src/class_incremental_reg_evm_training.py \
  --data_dir "$DATA_DIR"  \
  ...
  --evm_tailsize 0.3 \
  --evm_threshold 0.7 \
  --full_model_acc 0.6278 \
  --patience 5 \
  #--resume \
  #--resume_checkpoint "$RESUME_CKPT" \
  #--global_best_acc <previous_global_best_acc> 0.9321, 0.8480

echo "Class Incremental Learning WITH RegEVM Completed."


# To run:
# sbatch run_classIL_reg_evm_training_KD.sh
