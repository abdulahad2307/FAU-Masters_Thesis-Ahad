...
#SBATCH --job-name=eaml_CIL_with_KDILS        # Job name
...
#2
#BASE_MODEL="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_with_KDILS_Final/best_model_scientific_publication.pth"
...
#3
#BASE_MODEL="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_with_KDILS_Final/best_model_specification.pth"
...
#4
BASE_MODEL="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_with_KDILS_Final/best_model_file_folder.pth"
...
CKPT_DIR="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_with_KDILS_Final"

#RESUME_CKPT="/home/woody/iwi5/iwi5280h/eaml_cil/eaml_cil_with_KDILS_Final/epoch8_specification.pth"
mkdir -p $CKPT_DIR
...
python src/class_incremental.py \
  ...
  # --resume \
  # --resume_checkpoint "$RESUME_CKPT" \
  # --global_best_acc <previous_global_best_acc> 0.9321

echo "Class Incremental Learning Completed."


# To run:
# sbatch run_classIL_KD.sh
