...
#SBATCH --job-name=ocr_extraction_bbox_all_tesseract1        # Job name
...
OUTPUT_TENSOR="/home/woody/iwi5/iwi5280h/dataset/all_prepdataset_ocr_texts_bbox_tesseract8.pt"
