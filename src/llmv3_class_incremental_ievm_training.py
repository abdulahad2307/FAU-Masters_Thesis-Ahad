...
def main():
    ...
    for epoch in range(start_epoch, args.num_epochs):
        ...
        if val_acc > best_val_acc:
            ...
            save_path = os.path.join(args.checkpoint_dir, f"layoutlmv3_cil_incremental_ievm_{args.unseen_classes}_best.pt")
            torch.save({
                'epoch': epoch,
    ...
    best_ckpt = torch.load(os.path.join(args.checkpoint_dir, f"layoutlmv3_cil_incremental_ievm_{args.unseen_classes}_best.pt"), map_location=device)
