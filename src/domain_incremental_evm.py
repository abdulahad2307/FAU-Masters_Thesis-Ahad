...
def main(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        # EVM incremental update
        if args.use_evm and args.evm_update_freq > 0 and epoch % args.evm_update_freq == 0:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_evm", action="store_true", help="Enable EVM classifier for domain detection")
    parser.add_argument("--evm_tailsize", type=float, default=0.5, help="EVM tailsize parameter")
    parser.add_argument("--evm_threshold", type=float, default=0.7, help="EVM threshold for domain prediction")
    parser.add_argument("--evm_update_freq", type=int, default=5, help="Update EVM every N epochs")
