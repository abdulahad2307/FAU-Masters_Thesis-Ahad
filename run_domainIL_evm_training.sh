...
#SBATCH --job-name=dil_evm_training_SILS          # Job name
...
CHECKPOINT_DIR="/home/woody/iwi5/iwi5280h/dil_models/eaml_dil_evm_training_SILS2"
...
# To run:
# sbatch run_domainIL_evm_training.sh
