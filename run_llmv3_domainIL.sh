...
#SBATCH --job-name=dil_llmv3          # Job name
#SBATCH --output=llmv3_dil_logs/%x_%j.out    # Standard output log
#SBATCH --error=llmv3_dil_logs/%x_%j.err     # Error log
...
CHECKPOINT_DIR="/home/woody/iwi5/iwi5280h/llmv3_dil_normal_final"
...
python src/llmv3_domain_incremental.py \
  --data_dir /home/woody/iwi5/iwi5280h/dataset \
